...
import { ThreeScene, type SceneView } from "../../../korpus/three/ThreeScene";
import { FloorPlan } from "../../../korpus/components/FloorPlan";
import { WaterPicker } from "../../../korpus/components/WaterPicker";
import { OpeningThumb, FittingThumb } from "../../../korpus/components/Thumb";
import { OptionCard } from "../../../korpus/components/OptionCard";
import { Illustration } from "../../../korpus/quiz/Illustration";
import { FLOOR_COVERINGS, ROOM_TYPES } from "../../../korpus/model/floors";
import { fittingCatalog, fittingKind, openingCatalog, wallSegments, defaultFittingHeight, defaultOpeningSill, OPENING_FINISHES, type FittingCategory, type OpeningKind, type OpeningKindId, type Pt } from "../../../korpus/model/room";
import { WALL_COVERINGS, WALL_FAMILIES, familyCount, coveringColor as wallColorHex, dominantColor, leafRects, defaultSurface, type SurfPath } from "../../../korpus/model/walls";
import { matSwatchStyle } from "../../../korpus/three/pbr";
import {
  IconRoomShape,
  IconElements,
  IconOpenings,
